...
class ShoppingCart:
    ...
    def handle_payment(self, total: Decimal) -> None:
        payment_type = input(
        ...
        if payment_type in PAYMENT_HANDLERS:
            ...
            print(f"Sorry, we don't accept payment type '{payment_type}'")
...
def main() -> None:
    ...
    #     "What payment method would you like to use? (cc/paypal/apple) "
    # )
    cart.handle_payment(cart.total)
